...
<body>
  ...
  <section id="home" class="topContent">
    ...
    <div class="topContentImg">
      <img src="./images/homepage.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
  ...
  <footer>
    <div class="follow">
      ...
      <div class="social">
        ...
        <a href="https://www.linkedin.com/in/rahul-kumar-pal-7a3a821b3/" class="linkedin">
          <i class="fa fa-linkedin"></i>
        </a>
        <a href="https://www.instagram.com/_son_of_sunita/" class="instagram">
          <i class="fa fa-instagram"></i>
        </a>
      </div>
    </div>
    <p class="text-copy">
      Copyright &copy; 2021 , Developed By :- Arinjay Maurya
